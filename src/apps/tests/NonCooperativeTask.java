...
/**
 * Ein Task, der in einer Endlosschleife Zeichen auf dem Bildschirm ausgibt.
 */
	...
	protected void onSchedule() {
		while (true) {
			if (Timer.getUpTime() - this.lastChangedTime > delay) {
				...
				// Berechne neuen Wert
				this.total = this.total * this.constant
						+ ((int)(this.lastChangedTime ^ (this.lastChangedTime >> 32)));
